...
def guard(state):
    keys = ("organization_command", "property_economy", "character_paths", "world_conflict", "world_plans", "world_plan_outcomes", "adventures", "travel_access", "world_benefits", "location_details", "shops", "calendar_epoch", "calendar_anchor_day", "campaign_id", "world", "name", "turn", "canon_day", "canon_time_minutes", "world_time", "location", "position",
