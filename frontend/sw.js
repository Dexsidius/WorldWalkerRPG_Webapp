const CACHE = "worldwalker-v3590-shell-1";
const SHELL = [
  "/", "/css/style.css?v=3.59.0", "/js/app.js?v=3.59.0", "/css/world-atlas.css?v=3.59.0", "/js/world-atlas.js?v=3.59.0", "/manifest.webmanifest",
