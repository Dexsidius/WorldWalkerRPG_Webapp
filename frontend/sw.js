const CACHE = "worldwalker-v3620-shell-1";
const SHELL = [
  "/", "/css/style.css?v=3.62.0", "/js/app.js?v=3.62.0", "/css/world-atlas.css?v=3.62.0&revision=2", "/js/world-atlas.js?v=3.62.0", "/manifest.webmanifest",
