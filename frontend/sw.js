const CACHE = "worldwalker-v3640-shared-editions-1";
const SHELL = [
  "/js/world-calendar.js?v=3.64.0-shared-editions-1", "/js/living-adventures.js?v=3.64.0-shared-editions-1",
  "/css/living-adventures.css?v=3.64.0-shared-editions-1",
  "/js/api-client.js?v=3.64.0-shared-editions-1", "/js/roster-sync.js?v=3.64.0-shared-editions-1", "/js/team-membership.js?v=3.64.0-shared-editions-1", "/js/action-deck.js?v=3.64.0-shared-editions-1",
  "/css/compact-workspace.css?v=3.64.0-shared-editions-1",
  "/js/turn-feedback.js?v=3.64.0-shared-editions-1", "/css/turn-feedback.css?v=3.64.0-shared-editions-1",
  "/", "/css/style.css?v=3.64.0-shared-editions-1", "/js/app.js?v=3.64.0-shared-editions-1", "/css/world-atlas.css?v=3.64.0-shared-editions-1&revision=2", "/js/world-atlas.js?v=3.64.0-shared-editions-1", "/js/workspace-tabs.js?v=3.64.0-shared-editions-1", "/manifest.webmanifest",
