const CACHE = "worldwalker-v3640-simulation-reliability-2";
const SHELL = [
  "/js/world-calendar.js?v=3.64.0-simulation-reliability-2", "/js/living-adventures.js?v=3.64.0-simulation-reliability-2",
  "/css/living-adventures.css?v=3.64.0-simulation-reliability-2",
  "/js/api-client.js?v=3.64.0-simulation-reliability-2", "/js/roster-sync.js?v=3.64.0-simulation-reliability-2", "/js/team-membership.js?v=3.64.0-simulation-reliability-2", "/js/action-deck.js?v=3.64.0-simulation-reliability-2",
  "/css/compact-workspace.css?v=3.64.0-simulation-reliability-2",
  "/js/turn-feedback.js?v=3.64.0-simulation-reliability-2", "/css/turn-feedback.css?v=3.64.0-simulation-reliability-2",
  "/", "/css/style.css?v=3.64.0-simulation-reliability-2", "/js/app.js?v=3.64.0-simulation-reliability-2", "/css/world-atlas.css?v=3.64.0-simulation-reliability-2&revision=2", "/js/world-atlas.js?v=3.64.0-simulation-reliability-2", "/js/workspace-tabs.js?v=3.64.0-simulation-reliability-2", "/manifest.webmanifest",
